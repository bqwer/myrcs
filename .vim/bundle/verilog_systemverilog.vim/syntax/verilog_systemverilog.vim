...
syn keyword verilogBehavioral always assign initial
syn keyword verilogBehavioral always_comb always_ff always_latch


" syn keyword verilogStatement   always and assign automatic buf
syn keyword verilogStatement posedge negedge
syn keyword verilogStatement   and automatic buf
syn keyword verilogStatement   bufif0 bufif1 cell cmos
" syn keyword verilogStatement   config deassign defparam design
syn keyword verilogStatement   config defparam design
...
syn keyword verilogStatement   incdir include inout input
...
syn keyword verilogStatement   module nand nmos nor
...
syn keyword verilogStatement   output parameter pmos primitive
...
" Delays
syn match verilogDelay "#\w\+"

" Ranges
syn match verilogRangeBrackets  "[\[\]]"
syn match verilogRangeNumber '\d\+' contained display
syn region verilogRange start="\[" end="\]" contains=verilogRangeNumber,verilogConstant,verilogOperator
...
if version >= 508 || !exists("did_verilog_syn_inits")
   ...
   HiLink verilogBehavioral      Special
